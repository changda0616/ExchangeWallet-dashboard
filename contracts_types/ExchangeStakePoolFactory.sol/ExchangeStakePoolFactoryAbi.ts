...
export interface ExchangeStakePoolFactoryAbiInterface extends utils.Interface {
  functions: {
...
export interface ExchangeStakePoolFactoryAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExchangeStakePoolFactoryAbiInterface;
